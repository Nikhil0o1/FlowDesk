...
export function AddProjectPeopleModal({
  open,
  onClose,
  projectId,
  workspaceId,
    ...
    <>
      <Modal open={open} onClose={onClose} title="Add existing people" width="max-w-3xl">
        <p className="mb-4 text-sm text-fg-secondary">
          Organization members you can assign to spaces and projects in this workspace (including{' '}
          <span className="font-medium text-fg">{projectName}</span>). Org owners and admins are
          excluded.
        </p>
